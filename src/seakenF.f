...
c      if (x) 10,20,30
       ...
       CASE (-6:-1)
                t=-x
                cdfn=0.5/(1.0+0.0498673470*t+0.0211410061*t**2+0.0032776263*t**3 &
       ...
       CASE (0)
                ...
                return
       CASE (1:6)
                cdfn=1.0-0.5/(1.0+0.0498673470*x+0.0211410061*x**2+0.0032776263*x**3 &
                +0.380036e-4*x**4+0.488906e-4*x**5+0.53830e-5*x**6)**16
                return
       CASE (7:)
                cdfn=1.0
                return 
